package com.example.campusmapmap;
...
import com.example.campusmapmap.databinding.ActivityMapsBinding;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void direction(){
        ...
        String url = Uri.parse("https//,aps.googleapis.com/maps/api/directions/json")
                .buildUpon()
                .appendQueryParameter("destination", "-6.9218571, 107.6048254")
                .appendQueryParameter("origin","-6.9249233, 107.6345122")
                .appendQueryParameter("mode","driving")
                .appendQueryParameter("key","AIzaSyDBHtZwW2_6ImaVLP5w8iDFzDdBhPDgBsQ")
                .toString();
